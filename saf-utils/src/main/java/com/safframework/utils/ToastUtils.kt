...
object ToastUtils {
    ...
    @JvmStatic fun showToast(context: Context?, resId: Int,
                  duration: Int) {
        if (context == null)
            return
    ...
    @JvmStatic fun showLong(activity: Activity, resId: Int) {
        showToast(activity, resId, Toast.LENGTH_LONG)
    }

    @JvmStatic fun showLong(activity: Activity, message: String) {
    ...
    @JvmStatic fun showLong(context: Context, resId: Int) {
        showToast(context, resId, Toast.LENGTH_LONG)
    }

    @JvmStatic fun showLong(context: Context, message: String) {
        showToast(context, message, Toast.LENGTH_LONG)
    }

    @JvmStatic fun showShort(activity: Activity, resId: Int) {
        showToast(activity, resId, Toast.LENGTH_SHORT)
    }

    @JvmStatic fun showShort(activity: Activity, message: String) {
    ...
    @JvmStatic fun showShort(context: Context, resId: Int) {
        showToast(context, resId, Toast.LENGTH_SHORT)
    }

    @JvmStatic fun showShort(context: Context, message: String) {
